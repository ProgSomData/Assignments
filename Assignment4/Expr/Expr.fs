...
//Exercise 3.6
//added Parse module at the top of the file to load the fromString method we need from the Parse.fs file
let compString (s : string) : sinstr list =
      (s |> fromString |> scomp) []
      //ALT : scomp(fromString s) []
